...
- Exploit Development & Post-Exploitation Analysis
...
## Notable Work
- Reported high-impact vulnerabilities in large-scale production environments
- Discovered authentication and OTP bypasses across financial and political platforms
- Identified IDOR vulnerabilities exposing government-issued identity documents
...
- Legal and ethical research boundaries

Security research exists to **reduce risk**, not to create chaos.
